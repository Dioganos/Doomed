...
class ObjectRenderer:
    def __init__(self, game):
        ...
        self.sky_offset = 0
        self.blood_screen = self.get_texture('DOOM/resources/textures/blood_screen.png', RES)
        self.digit_size = 90
        self.digit_images = [self.get_texture(f'DOOM/resources/textures/digits/{i}.png', [self.digit_size] * 2)
                             for i in range(11)]
        self.digits = dict(zip(map(str, range(11)), self.digit_images))
        self.game_over_image = self.get_texture('DOOM/resources/textures/game_over.png', RES)
        self.win_image = self.get_texture('DOOM/resources/textures/win.png', RES)
